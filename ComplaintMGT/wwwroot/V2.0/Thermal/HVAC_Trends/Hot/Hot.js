...
$(document).ready(function () {
    ...
    $.getJSON('/v2.0/Thermal/HVAC_Trends/Hot/EnergyConsumption_Graph_Config.json', function (data) {
        buildAllGraphs(data);
    }).fail(function () {
...
function buildAllGraphs(configData) {
    var graphConfigs = [
        ...
        { id: 3, name: 'Thermal Monitoring HVAC - Hourly Average', containerId: 'hvacHourlyAvgGraph' },
        { id: 4, name: 'Thermal Profile - Hourly Average', containerId: 'hvacHeatmapGraph' }
    ];
