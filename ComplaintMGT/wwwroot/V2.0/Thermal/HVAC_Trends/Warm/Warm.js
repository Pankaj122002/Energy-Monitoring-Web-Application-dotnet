...
$(document).ready(function () {
    ...
    $.getJSON('/v2.0/Thermal/HVAC_Trends/warm/EnergyConsumption_Graph_Config.json', function (data) {
        buildAllGraphs(data);
    }).fail(function () {
...
function buildAllGraphs(configData) {
    var graphConfigs = [
        ...
        { id: 3, name: 'Thermal Monitoring HVAC - Daily Average', containerId: 'hvacHourlyAvgGraph' },
        { id: 4, name: 'Thermal Profile - Daily Average', containerId: 'hvacHeatmapGraph' }
    ];
