...
$(document).ready(function () {
    ...
    $.getJSON('/v2.0/Thermal/Ambient_Humidity_trends/warm/EnergyConsumption_Graph_Config.json', function (data) {
        buildAllGraphs(data);
    }).fail(function () {
...
function buildAllGraphs(configData) {
    var graphConfigs = [
        ...
        { id: 3, name: 'Ambient Humidity Monitoring - Daily Average', containerId: 'hvacHourlyAvgGraph' },
        { id: 4, name: 'Ambient Humidity Profile - Daily Average', containerId: 'hvacHeatmapGraph' }
    ];
