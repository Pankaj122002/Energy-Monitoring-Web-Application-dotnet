...
//   Graph 2 - Peak Humidity (line)     → sp_GetThermalMonitoringHVAC_AverageTrends_Cold
//                                            Columns: Deviceid, Asset, Humidity, Month, WeekStart, WeekEnd
...
var hvacThermalDashboard = (function () {
    ...
    function ensureLiveCache(assets, callback) {
        ...
        assets.forEach(function (asset) {
            ...
            $.ajax({
                type: 'POST',
                url: '/Thermal/GetHumidityMonitoringAmbient_live_ByAssetId_cold?assetid=' + encodeURIComponent(id),
                success: function (result) {
                    var response = typeof result === 'string' ? JSON.parse(result) : result;
    ...
    // API returns: Deviceid, Asset, Humidity, Month, WeekStart, WeekEnd
    ...
    // Returns: Deviceid, Asset, Humidity, Month, WeekStart, WeekEnd
    function ensureAvgCache(assets, callback) {
        ...
        assets.forEach(function (asset) {
            ...
            $.ajax({
                type: 'POST',
                url: '/Thermal/GetHumidityMonitoringAmbient_AverageTrends_cold?assetid=' + encodeURIComponent(id),
                success: function (result) {
                    var response = typeof result === 'string' ? JSON.parse(result) : result;
