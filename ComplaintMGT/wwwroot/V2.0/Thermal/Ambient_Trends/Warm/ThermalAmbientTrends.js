...
var hvacThermalDashboard = (function () {
    ...
    function ensureLiveCache(assets, callback) {
        ...
        assets.forEach(function (asset) {
            ...
            $.ajax({
                type: 'POST',
                url: '/Thermal/GetThermalMonitoringAmbient_live_ByAssetId_warm?assetid=' + encodeURIComponent(id),
                success: function (result) {
                    var response = typeof result === 'string' ? JSON.parse(result) : result;
    ...
    // Returns: Deviceid, Asset, Temperature, TransactionDay
    function ensureAvgCache(assets, callback) {
        ...
        assets.forEach(function (asset) {
            ...
            $.ajax({
                type: 'POST',
                url: '/Thermal/GetThermalMonitoringAmbient_AverageTrends_warm?assetid=' + encodeURIComponent(id),
                success: function (result) {
                    var response = typeof result === 'string' ? JSON.parse(result) : result;
