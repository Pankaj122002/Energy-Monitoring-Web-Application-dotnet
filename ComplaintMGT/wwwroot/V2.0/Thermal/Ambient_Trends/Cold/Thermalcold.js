...
$(document).ready(function () {
    ...
    $.getJSON('/v2.0/Thermal/Ambient_trends/cold/EnergyConsumption_Graph_Config.json', function (data) {
        buildAllGraphs(data);
    }).fail(function () {
...
function buildAllGraphs(configData) { 
    var graphConfigs = [
        { id: 1, name: 'Ambient Thermal Monitoring', containerId: 'hvacLiveGraph' },
        { id: 2, name: 'Ambient Thermal Monitoring - Peak Temperature', containerId: 'hvacPeakGraph' },
        { id: 3, name: 'Ambient Thermal Monitoring - Weekly Average', containerId: 'hvacHourlyAvgGraph' },
        { id: 4, name: 'Ambient Thermal Profile - Weekly Average', containerId: 'hvacHeatmapGraph' }
    ];
