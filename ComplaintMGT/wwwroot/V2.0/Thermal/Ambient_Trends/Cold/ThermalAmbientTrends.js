...
var hvacThermalDashboard = (function () {
    ...
    function ensureLiveCache(assets, callback) {
        ...
        assets.forEach(function (asset) {
            ...
            $.ajax({
                type: 'POST',
                url: '/Thermal/GetThermalMonitoringAmbient_live_ByAssetId_cold?assetid=' + encodeURIComponent(id),
                success: function (result) {
                    var response = typeof result === 'string' ? JSON.parse(result) : result;
    ...
    function ensureAvgCache(assets, callback) {
        ...
        assets.forEach(function (asset) {
            ...
            $.ajax({
                type: 'POST',
                url: '/Thermal/GetThermalMonitoringAmbient_AverageTrends_cold?assetid=' + encodeURIComponent(id),
                success: function (result) {
                    var response = typeof result === 'string' ? JSON.parse(result) : result;
