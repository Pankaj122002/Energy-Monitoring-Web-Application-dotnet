var guestComfortDashboard = function () {
    ...
    var _echartsguestA1ChartDashboard = function () {
        ...
        $.ajax({
            type: "GET",
            url: "/Deshboard/GetEmployeeGuestComfortDashboard_Warm?fromDate=" + from + "&toDate=" + to,
    ...
    var _echartsguestA2ChartDashboard = function () {
        ...
        $.ajax({
            type: "GET",
            url: "/Deshboard/GetEmployeeGuestComfortDashboardDetail_Warm?fromDate=" + from + "&toDate=" + to,
            success: function (data) {
                myChart.hideLoading();
                var myJSON = JSON.parse(data);
    ...
    var _echartshr1ChartDashboard = function () {
        ...
        const monthLabels = ['Today', 'CurrentWeek', 'PreviousWeek', currentMonthName];

        Promise.all([
            $.ajax({
                type: "GET",
                url: "/Deshboard/GetEmployeeGuestComfortDashboard_Warm?fromDate=" + from1 + "&toDate=" + to1,
            }),
            $.ajax({
                type: "GET",
                url: "/Deshboard/GetEmployeeGuestComfortDashboard_Warm?fromDate=" + from2 + "&toDate=" + to2,
            }),
            $.ajax({
                type: "GET",
                url: "/Deshboard/GetEmployeeGuestComfortDashboard_Warm?fromDate=" + from3 + "&toDate=" + to3,
            }),
            $.ajax({
                type: "GET",
                url: "/Deshboard/GetEmployeeGuestComfortDashboard_Warm?fromDate=" + from + "&toDate=" + to,
            ...
            var option = {
                ...
                series: {
                    name: 'Employee',
                    type: 'bar',
                    data: [employeeComfort1, employeeComfort2, employeeComfort3, employeeComfort4],
                    itemStyle: {
        ...
        Promise.all([
            ...
            var option = {
                ...
                series: {
                    name: 'guestComfort',
                    type: 'bar',
                    data: [guestComfort1, guestComfort2, guestComfort3, guestComfort4],
                    itemStyle: {
                        borderRadius: [10, 10, 0, 0]
                    },
                    color: "#91cc75"
    ...
    var _echartshr3ChartDashboard = function () {
        ...
        Promise.all([
            $.ajax({
                type: "GET",
                url: "/Deshboard/GetEmployeeGuestComfortDashboardDetail_Warm?fromDate=" + from1 + "&toDate=" + to1,
            }),
            $.ajax({
                type: "GET",
                url: "/Deshboard/GetEmployeeGuestComfortDashboardDetail_Warm?fromDate=" + from2 + "&toDate=" + to2,
            }),
            $.ajax({
                type: "GET",
                url: "/Deshboard/GetEmployeeGuestComfortDashboardDetail_Warm?fromDate=" + from3 + "&toDate=" + to3,
            }),
            $.ajax({
                type: "GET",
                url: "/Deshboard/GetEmployeeGuestComfortDashboardDetail_Warm?fromDate=" + from + "&toDate=" + to,
                ...
                series: [
                    {
                        name: 'UnderCooling',
                        type: 'bar',
                        data: [UnderCooling1, UnderCooling2, UnderCooling3, UnderCooling4],
                        itemStyle: {
                            borderRadius: [10, 10, 0, 0]
                        },
                        color: "#f28b82"
                    },
                    {
                        name: 'OverCooling',
                        type: 'bar',
                        data: [OverCooling1, OverCooling2, OverCooling3, OverCooling4],
                        itemStyle: {
                            borderRadius: [10, 10, 0, 0]
                        },
                        color: '#80bdff'
    ...
    var _echartsProductionDining1ChartDashboard = function () {
        ...
        $.ajax({
            type: "GET",
            url: "/Deshboard/GetEmployeeGuestComfortDashboardOps_Warm?fromDate=" + from + "&toDate=" + to,
            success: function (data) {
                myChart.hideLoading();
    ...
    var _echartsProductionDining2ChartDashboard = function () {
        ...
        $.ajax({
            type: "GET",
            url: "/Deshboard/GetEmployeeGuestComfortDashboardNonOps_Warm?fromDate=" + from + "&toDate=" + to,
            success: function (data) {
                myChart.hideLoading();
    ...
    var _echartsProductionDiningOU1ChartDashboard = function () {
        ...
        $.ajax({
            type: "GET",
            url: "/Deshboard/GetEmployeeGuestComfortDashboardDetailOps_Warm?fromDate=" + from + "&toDate=" + to,
            success: function (data) {
                myChart.hideLoading();
                var myJSON = JSON.parse(data);
                let guestComfort;
    ...
    var _echartsProductionDiningOU2ChartDashboard = function () {
        ...
        $.ajax({
            type: "GET",
            url: "/Deshboard/GetEmployeeGuestComfortDashboardDetailNonOps_Warm?fromDate=" + from + "&toDate=" + to,
            success: function (data) {
                myChart.hideLoading();
                var myJSON = JSON.parse(data);
                let guestComfort;
