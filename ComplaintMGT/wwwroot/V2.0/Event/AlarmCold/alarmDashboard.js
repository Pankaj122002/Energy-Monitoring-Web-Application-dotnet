var alarmsDashboard = function () {
    ...
    function getLastMonthRange() {
        ...
        const toDate = new Date(now.getFullYear(), now.getMonth(), 0, 23, 59, 59, 999); // Last day of previous month
        return {
    ...
    function getLastThreeMonthsToTodayRange() {
        ...
        // Start: 1st day of the month, 3 months ago at 00:00
        const fromDate = new Date(now.getFullYear(), now.getMonth() - 3, 1, 0, 0, 0, 0);
    ...
    var _echartsalarmsA1ChartDashboard = function () {
        ...
        $.ajax({
            type: "GET",
            url: "/deshboard/GetAlertCountByDateTime_Cold?from=" + from + "&to=" + to,
            data: {},
    ...
    var _echartsThermalAlarmsChartDashboard = function () {
        ...
        Promise.all([
            $.ajax({
                type: "GET",
                url: "/deshboard/GetAlertCountByDateTime_Cold?from=" + from1 + "&to=" + to1
            }),
            $.ajax({
                type: "GET",
                url: "/deshboard/GetAlertCountByDateTime_Cold?from=" + from2 + "&to=" + to2
            }),
            $.ajax({
                type: "GET",
                url: "/deshboard/GetAlertCountByDateTime_Cold?from=" + from3 + "&to=" + to3
            }),
            $.ajax({
                type: "GET",
                url: "/deshboard/GetAlertCountByDateTime_Cold?from=" + from4 + "&to=" + to4
            })
            ...
            let alertCount3 = data3[0].AlertCount;
            let alertCount4 = data4[0].AlertCount;

            thermalArray.push(alertCount1);
            thermalArray.push(alertCount2);
            thermalArray.push(alertCount3);
            thermalArray.push(alertCount4);
    ...
    var _echartsOpsScheduleWiseDistributionofAlarmsChartDashboard = function () {
        ...
        $.ajax({
            type: "GET",
            url: "/Deshboard/GetOperationsWiseAlerts_Cold?fromDate=" + from + "&toDate=" + to,
            success: function (data) {
                myChart.hideLoading();
                let jsonObject = JSON.parse(data);
