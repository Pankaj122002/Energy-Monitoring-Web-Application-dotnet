var alarmsDashboard = function () {
    ...
    var _echartsalarmsA1ChartDashboard = function () {
        ...
        $.ajax({
            type: "GET",
            url: "/deshboard/GetAlertCountByDateTime_Warm?from=" + from + "&to=" + to,
            data: {},
    ...
    var _echartsThermalAlarmsChartDashboard = function () {
        ...
        const monthLabels = ['Today', 'Curr.Week', 'Pr.Week', currentMonthName];
        ...
        Promise.all([
            $.ajax({
                type: "GET",
                url: "/deshboard/GetAlertCountByDateTime_Warm?from=" + from1 + "&to=" + to1
            }),
            $.ajax({
                type: "GET",
                url: "/deshboard/GetAlertCountByDateTime_Warm?from=" + from2 + "&to=" + to2
            }),
            $.ajax({
                type: "GET",
                url: "/deshboard/GetAlertCountByDateTime_Warm?from=" + from3 + "&to=" + to3
            }),
            $.ajax({
                type: "GET",
                url: "/deshboard/GetAlertCountByDateTime_Warm?from=" + from + "&to=" + to
    ...
    var _echartsOpsScheduleWiseDistributionofAlarmsChartDashboard = function () {
        ...
        $.ajax({
            type: "GET",
            url: "/Deshboard/GetOperationsWiseAlerts_Warm?fromDate=" + from + "&toDate=" + to,
            success: function (data) {
                myChart.hideLoading();
                let jsonObject = JSON.parse(data);
